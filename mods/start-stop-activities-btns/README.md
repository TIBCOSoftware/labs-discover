# Start and Stop Activities selection Mod
This mod displays creates buttons to let the user select Start and Stop activities, for a Processing mining analysis.
