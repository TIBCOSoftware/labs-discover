...
public class UpdateReference extends BaseProcedure {
    ...
    protected ParameterInfo[] getAdditionalInputs() {
        return new ParameterInfo[]{
                ...
                new ParameterInfo("isReference", Types.INTEGER, DIRECTION_IN),
    ...
    private String getSqlQuery(String path, Object[] additionalInputs) {
        ...
        return ("UPDATE " +
                ...
                " SET isReference = " +
                additionalInputs[1] +
                " WHERE analysis_id = '" +additionalInputs[0] + "' AND variant_id IN (" +
                additionalInputs[2] + ");");
    }
