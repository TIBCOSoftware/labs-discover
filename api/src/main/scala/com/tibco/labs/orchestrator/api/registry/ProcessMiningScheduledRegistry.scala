...
import com.tibco.labs.orchestrator.api.methods.SparkScheduledOnK8s
...
object ProcessMiningScheduledRegistry {
  ...
  // response
  final case class ActionPerformedSchedules(message: String, code: Int, status: String, jobName: String)
