 ...
 */
export interface ClaimsSandbox { 
    id: string;
    /**
     * The type of Sandbox
     */
    type: ClaimsSandboxTypeEnum;
    /**
     * The Groups to which the user with this Sandbox has access
     */
    groups: ClaimsGroup[];
}
    export type ClaimsSandboxTypeEnum = 'Production' | 'Developer';
    export const ClaimsSandboxTypeEnum = {
        Production: 'Production' as ClaimsSandboxTypeEnum,
        Developer: 'Developer' as ClaimsSandboxTypeEnum
    };
