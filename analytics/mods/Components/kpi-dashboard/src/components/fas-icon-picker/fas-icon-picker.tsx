...
@Component({
  tag: 'fas-icon-picker',
  styleUrl: 'fas-icon-picker.css',
  shadow: true,
})
export class FasIconPicker implements ComponentInterface {
  @Prop() name: string;
  @Prop({mutable: true}) value: string;
  @Element() private element: HTMLElement;

  private showMenu(){
    let popover: HTMLElement = this.element.shadowRoot.querySelector("div.popover");
    popover.style.display = "block";
  }

  private selectIcon(icon: { title: string, searchTerms: string[] }) {
    let popover: HTMLElement = this.element.shadowRoot.querySelector("div.popover");
    popover.style.display = "none";
    this.value = icon.title
  ...
  render() {
    return (
      <Host>
        <div class="btn-group">
          <button type="button" class="icp icp-dd btn btn-default dropdown-toggle iconpicker-component iconpicker-element" onClick={() => this.showMenu()}>
            {this.name} <i class={this.value}></i>
            ...
            <div class="popover-content">
              <div class="iconpicker">
                <div class="iconpicker-items">
                  {this.icons.map((icon) =>
                    <a role="button" href="javascript:;" class="iconpicker-item" onClick={() => this.selectIcon(icon)}><i class={icon.title}></i></a>
                  )}
                </div>
              </div>
