...
// export namespace InstanceState {
    export type InstanceStateStateEnum = 'STARTING' | 'ACTIVE' | 'COMPLETED' | 'CANCELLED' | 'HALTED' | 'UNKNOWN' | 'DELAYED';
    export const InstanceStateStateEnum = {
        STARTING: 'STARTING' as InstanceStateStateEnum,
        ACTIVE: 'ACTIVE' as InstanceStateStateEnum,
        COMPLETED: 'COMPLETED' as InstanceStateStateEnum,
        CANCELLED: 'CANCELLED' as InstanceStateStateEnum,
        HALTED: 'HALTED' as InstanceStateStateEnum,
        UNKNOWN: 'UNKNOWN' as InstanceStateStateEnum,
        DELAYED: 'DELAYED' as InstanceStateStateEnum
    };
// }
