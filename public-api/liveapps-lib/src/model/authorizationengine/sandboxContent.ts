...
export interface SandboxContent { 
     ...
     * The type of Sandbox
     */
    type: SandboxContentTypeEnum;
    /**
     * The subscription to which this Sandbox belongs
     */
    subscriptionId?: string;
    /**
     * The id of the User that owns the Sandbox
     */
    ownerId?: string;
}
    export type SandboxContentTypeEnum = 'Production' | 'Developer';
    export const SandboxContentTypeEnum = {
        Production: 'Production' as SandboxContentTypeEnum,
        Developer: 'Developer' as SandboxContentTypeEnum
    };
