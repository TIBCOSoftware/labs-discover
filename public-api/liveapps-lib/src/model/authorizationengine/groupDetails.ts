...
export interface GroupDetails { 
     ...
     */
    type?: GroupDetailsTypeEnum;
}
    export type GroupDetailsTypeEnum = 'AllUsers' | 'Administrator' | 'ApplicationDeveloper' | 'UIDeveloper' | 'SubscriptionDefined';
    export const GroupDetailsTypeEnum = {
        AllUsers: 'AllUsers' as GroupDetailsTypeEnum,
        Administrator: 'Administrator' as GroupDetailsTypeEnum,
        ApplicationDeveloper: 'ApplicationDeveloper' as GroupDetailsTypeEnum,
        UIDeveloper: 'UIDeveloper' as GroupDetailsTypeEnum,
        SubscriptionDefined: 'SubscriptionDefined' as GroupDetailsTypeEnum
    };
