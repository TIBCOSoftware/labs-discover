...
export interface ClaimsGroup { 
     ...
     * The type of Group
     */
    type: ClaimsGroupTypeEnum;
}
    export type ClaimsGroupTypeEnum = 'AllUsers' | 'Administrator' | 'ApplicationDeveloper' | 'UIDeveloper' | 'SubscriptionDefined';
    export const ClaimsGroupTypeEnum = {
        AllUsers: 'AllUsers' as ClaimsGroupTypeEnum,
        Administrator: 'Administrator' as ClaimsGroupTypeEnum,
        ApplicationDeveloper: 'ApplicationDeveloper' as ClaimsGroupTypeEnum,
        UIDeveloper: 'UIDeveloper' as ClaimsGroupTypeEnum,
        SubscriptionDefined: 'SubscriptionDefined' as ClaimsGroupTypeEnum
    };
