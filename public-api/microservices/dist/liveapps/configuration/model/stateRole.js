...
exports.StateRole = StateRole;
StateRole.discriminator = undefined;
StateRole.attributeTypeMap = [
    {
        "name": "entityId",
        "baseName": "entityId",
        "type": "string"
...
(function (StateRole) {
    ...
    (function (RoleEnum) {
        ...
        RoleEnum[RoleEnum["Author"] = 'AUTHOR'] = "Author";
        RoleEnum[RoleEnum["Recipient"] = 'RECIPIENT'] = "Recipient";
    })(RoleEnum = StateRole.RoleEnum || (StateRole.RoleEnum = {}));
    let EntityTypeEnum;
    (function (EntityTypeEnum) {
        EntityTypeEnum[EntityTypeEnum["AllUsers"] = 'AllUsers'] = "AllUsers";
        EntityTypeEnum[EntityTypeEnum["Administrator"] = 'Administrator'] = "Administrator";
        EntityTypeEnum[EntityTypeEnum["ApplicationDeveloper"] = 'ApplicationDeveloper'] = "ApplicationDeveloper";
        EntityTypeEnum[EntityTypeEnum["UiDeveloper"] = 'UiDeveloper'] = "UiDeveloper";
        EntityTypeEnum[EntityTypeEnum["SubscriptionDefined"] = 'SubscriptionDefined'] = "SubscriptionDefined";
    })(EntityTypeEnum = StateRole.EntityTypeEnum || (StateRole.EntityTypeEnum = {}));
})(StateRole = exports.StateRole || (exports.StateRole = {}));
//# sourceMappingURL=stateRole.js.map