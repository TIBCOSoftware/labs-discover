...
class ApplicationsApi {
     ...
     */
    copyApp(appName, details, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let localVarRequestOptions = {
                ...
                json: true,
                body: models_1.ObjectSerializer.serialize(details, "Application")
            };
     ...
     */
    copySysApp(appName, details, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let localVarRequestOptions = {
                ...
                useQuerystring: this._useQuerystring,
                json: true,
                body: models_1.ObjectSerializer.serialize(details, "SystemApplication")
            };
            let authenticationPromise = Promise.resolve();
            authenticationPromise = authenticationPromise.then(() => this.authentications.default.applyToRequest(localVarRequestOptions));
            let interceptorPromise = authenticationPromise;
     ...
     */
    createApp(appName, appContents, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     */
    createAppArtifact(appName, artifactContents, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/applications/{appName}/upload/'
                .replace('{' + 'appName' + '}', encodeURIComponent(String(appName)));
            let localVarQueryParameters = {};
     ...
     */
    createEmptyApp(details, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     */
    deleteApp(appName, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/applications/{appName}/'
                .replace('{' + 'appName' + '}', encodeURIComponent(String(appName)));
            let localVarQueryParameters = {};
     ...
     */
    exportApp(appName, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     */
    getApps($filter, $skip, $top, $orderby, $select, $count, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/applications/';
            let localVarQueryParameters = {};
            let localVarHeaderParams = Object.assign({}, this._defaultHeaders);
     ...
     */
    getAppsByName(appName, $select, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/applications/{appName}/'
                .replace('{' + 'appName' + '}', encodeURIComponent(String(appName)));
            let localVarQueryParameters = {};
     ...
     */
    getSysApps($filter, $skip, $top, $orderby, $select, $count, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
                ...
                return new Promise((resolve, reject) => {
                    request_1.default(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            ...
                            body = models_1.ObjectSerializer.deserialize(body, "Array<SystemApplication>");
                            if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                resolve({ response: response, body: body });
                            }
                            else {
     ...
     * @param $select Whether the descriptor attribute for the Application should be included in the returned information. (The descriptor attribute contains the name/value pairs defined in the Application\&#39;s _appName_.app.desc.json file, if it has one.) The only valid value is:  * __summary__: Excludes the descriptor attribute from the returned information.  For example:  $select&#x3D;summary  If $select is not specified the descriptor attribute is included in the returned information.
     */
    getSysAppsByName(appName, $select, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/systemApplications/{appName}/'
                .replace('{' + 'appName' + '}', encodeURIComponent(String(appName)));
            let localVarQueryParameters = {};
                ...
                return new Promise((resolve, reject) => {
                    request_1.default(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            ...
                            body = models_1.ObjectSerializer.deserialize(body, "SystemApplication");
                            if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                resolve({ response: response, body: body });
                            }
                            else {
     ...
     */
    publishApp(appName, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/applications/{appName}/'
                .replace('{' + 'appName' + '}', encodeURIComponent(String(appName)));
            let localVarQueryParameters = {};
