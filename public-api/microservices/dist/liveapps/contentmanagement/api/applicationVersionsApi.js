...
exports.ApplicationVersionsApi = exports.ApplicationVersionsApiApiKeys = void 0;
...
// ===============================================
var ApplicationVersionsApiApiKeys;
(function (ApplicationVersionsApiApiKeys) {
})(ApplicationVersionsApiApiKeys = exports.ApplicationVersionsApiApiKeys || (exports.ApplicationVersionsApiApiKeys = {}));
class ApplicationVersionsApi {
    ...
    setApiKey(key, value) {
        this.authentications[ApplicationVersionsApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    deleteAppVersion(appName, version, options = { headers: {} }) {
     ...
     */
    getAppVersion(appName, version, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/applications/{appName}/applicationVersions/{version}/'
                .replace('{' + 'appName' + '}', encodeURIComponent(String(appName)))
                .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
                ...
                return new Promise((resolve, reject) => {
                    request_1.default(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            ...
                            body = models_1.ObjectSerializer.deserialize(body, "ApplicationVersion");
                            if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                resolve({ response: response, body: body });
                            }
                            else {
     ...
     */
    getAppVersions(appName, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
                ...
                return new Promise((resolve, reject) => {
                    request_1.default(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            ...
                            body = models_1.ObjectSerializer.deserialize(body, "Array<ApplicationVersion>");
                            if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                resolve({ response: response, body: body });
                            }
                            else {
     ...
     * @param version The ApplicationVersion to be returned.
     */
    getSysAppVersion(appName, version, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     */
    getSysAppVersions(appName, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     */
    revertApp(appName, version, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/applications/{appName}/applicationVersions/{version}/'
                .replace('{' + 'appName' + '}', encodeURIComponent(String(appName)))
                .replace('{' + 'version' + '}', encodeURIComponent(String(version)));
     ...
     */
    updateAppVersion(appName, details, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/applications/{appName}/applicationVersions/'
                .replace('{' + 'appName' + '}', encodeURIComponent(String(appName)));
            let localVarQueryParameters = {};
            ...
            let localVarRequestOptions = {
                ...
                useQuerystring: this._useQuerystring,
                json: true,
                body: models_1.ObjectSerializer.serialize(details, "ApplicationVersion")
            };
            let authenticationPromise = Promise.resolve();
            authenticationPromise = authenticationPromise.then(() => this.authentications.default.applyToRequest(localVarRequestOptions));
            let interceptorPromise = authenticationPromise;
...
exports.ApplicationVersionsApi = ApplicationVersionsApi;
//# sourceMappingURL=applicationVersionsApi.js.map