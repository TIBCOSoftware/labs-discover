...
exports.ArtifactsApi = exports.ArtifactsApiApiKeys = void 0;
...
// ===============================================
var ArtifactsApiApiKeys;
(function (ArtifactsApiApiKeys) {
})(ArtifactsApiApiKeys = exports.ArtifactsApiApiKeys || (exports.ArtifactsApiApiKeys = {}));
class ArtifactsApi {
    ...
    setApiKey(key, value) {
        this.authentications[ArtifactsApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    createAppArtifactSingle(appName, artifactName, binaryData, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let localVarRequestOptions = {
                ...
                json: true,
                body: models_1.ObjectSerializer.serialize(binaryData, "string")
            };
                ...
                return new Promise((resolve, reject) => {
                    request_1.default(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            ...
                            body = models_1.ObjectSerializer.deserialize(body, "Status");
     ...
     */
    createFolderArtifact(folderName, artifactName, $sandbox, artifactContents, description, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     * @param description A suitable description for the new or updated Artifact.
     */
    createOrgFolderArtifact(folderName, artifactName, artifactContents, description, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     */
    deleteAppArtifact(appName, artifactName, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/applications/{appName}/applicationVersions/artifacts/{artifactName}/'
                .replace('{' + 'appName' + '}', encodeURIComponent(String(appName)))
                .replace('{' + 'artifactName' + '}', encodeURIComponent(String(artifactName)));
     ...
     * @param $sandbox The id of the Sandbox that contains the Case Folder.
     */
    deleteFolderArtifact(folderName, artifactName, $sandbox, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     * @param artifactName The name of the Artifact to be deleted.
     */
    deleteOrgFolderArtifact(folderName, artifactName, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     */
    getAppArtifacts(appName, version, $filter, $skip, $top, $count, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
                ...
                return new Promise((resolve, reject) => {
                    request_1.default(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            ...
                            body = models_1.ObjectSerializer.deserialize(body, "Array<Artifact>");
                            if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                resolve({ response: response, body: body });
                            }
                            else {
     ...
     */
    getFolderArtifactVersions(folderName, artifactName, $sandbox, $skip, $top, $count, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     */
    getFolderArtifacts(folderName, $sandbox, $filter, $skip, $top, $orderby, $count, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     * @param $count If set to \&#39;TRUE\&#39;, returns the number of versions of the specified Artifact in the result, rather than the versions themselves.   Note: If $count is used, $skip or $top cannot be used.
     */
    getOrgFolderArtifactVersions(folderName, artifactName, $skip, $top, $count, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     * @param $count If set to \&#39;TRUE\&#39;, returns the number of Artifacts in the result, rather than the Artifacts themselves.   Note: If $count is used, $skip, $top or $orderby cannot be used.
     */
    getOrgFolderArtifacts(folderName, $filter, $skip, $top, $orderby, $count, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     * @param $count If set to \&#39;TRUE\&#39;, returns the number of Artifacts in the result, rather than the Artifacts themselves.   Note: If $count is used, $skip or $top cannot be used.
     */
    getSysAppArtifacts(appName, version, $filter, $skip, $top, $count, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     */
    renameAppArtifact(appName, artifactName, details, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/applications/{appName}/applicationVersions/artifacts/{artifactName}/'
                .replace('{' + 'appName' + '}', encodeURIComponent(String(appName)))
                .replace('{' + 'artifactName' + '}', encodeURIComponent(String(artifactName)));
            ...
            let localVarRequestOptions = {
                ...
                useQuerystring: this._useQuerystring,
                json: true,
                body: models_1.ObjectSerializer.serialize(details, "Artifact")
            };
            let authenticationPromise = Promise.resolve();
            authenticationPromise = authenticationPromise.then(() => this.authentications.default.applyToRequest(localVarRequestOptions));
            let interceptorPromise = authenticationPromise;
...
//# sourceMappingURL=artifactsApi.js.map