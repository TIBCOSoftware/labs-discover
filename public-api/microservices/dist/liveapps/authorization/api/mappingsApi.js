...
exports.MappingsApi = exports.MappingsApiApiKeys = void 0;
...
// ===============================================
var MappingsApiApiKeys;
(function (MappingsApiApiKeys) {
})(MappingsApiApiKeys = exports.MappingsApiApiKeys || (exports.MappingsApiApiKeys = {}));
class MappingsApi {
    ...
    setApiKey(key, value) {
        this.authentications[MappingsApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    createUserGroupMapping(userGroupMappingContents, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let localVarRequestOptions = {
                ...
                json: true,
                body: models_1.ObjectSerializer.serialize(userGroupMappingContents, "UserGroupMappingContent")
            };
     ...
     */
    deleteUserGroupMapping(id, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     * @param id The unique identifier of the required user group Mapping.
     */
    getGroupForUserGroupMapping(id, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     * @param id The unique identifier of the required user group Mapping.
     */
    getSandboxForUserGroupMapping(id, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     * @param id The unique identifier of the required user group Mapping.
     */
    getUserForUserGroupMapping(id, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     * @param id The unique identifier of the required user group Mapping.
     */
    getUserGroupMapping(id, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/userGroupMappings/{id}'
                .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
            let localVarQueryParameters = {};
                ...
                return new Promise((resolve, reject) => {
                    request_1.default(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            ...
                            body = models_1.ObjectSerializer.deserialize(body, "UserGroupMapping");
                            if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                resolve({ response: response, body: body });
                            }
                            else {
     ...
     */
    getUserGroupMappings($sandbox, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/userGroupMappings';
            let localVarQueryParameters = {};
            let localVarHeaderParams = Object.assign({}, this._defaultHeaders);
...
//# sourceMappingURL=mappingsApi.js.map