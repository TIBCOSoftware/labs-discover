...
exports.ClaimsGroup = void 0;
/**
* The Group details needed by the Claims
*/
class ClaimsGroup {
    static getAttributeTypeMap() {
        return ClaimsGroup.attributeTypeMap;
    }
}
exports.ClaimsGroup = ClaimsGroup;
ClaimsGroup.discriminator = undefined;
ClaimsGroup.attributeTypeMap = [
    {
        "name": "id",
        "baseName": "id",
        "type": "string"
    },
    {
        "name": "type",
        "baseName": "type",
        "type": "ClaimsGroup.TypeEnum"
    }
];
(function (ClaimsGroup) {
    let TypeEnum;
    (function (TypeEnum) {
        TypeEnum[TypeEnum["AllUsers"] = 'AllUsers'] = "AllUsers";
        TypeEnum[TypeEnum["Administrator"] = 'Administrator'] = "Administrator";
        TypeEnum[TypeEnum["ApplicationDeveloper"] = 'ApplicationDeveloper'] = "ApplicationDeveloper";
        TypeEnum[TypeEnum["UiDeveloper"] = 'UIDeveloper'] = "UiDeveloper";
        TypeEnum[TypeEnum["SubscriptionDefined"] = 'SubscriptionDefined'] = "SubscriptionDefined";
    })(TypeEnum = ClaimsGroup.TypeEnum || (ClaimsGroup.TypeEnum = {}));
})(ClaimsGroup = exports.ClaimsGroup || (exports.ClaimsGroup = {}));
//# sourceMappingURL=claimsGroup.js.map