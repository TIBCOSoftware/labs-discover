...
exports.ClaimsSandbox = void 0;
/**
* The Sandbox details needed by the Claims
*/
class ClaimsSandbox {
    static getAttributeTypeMap() {
        return ClaimsSandbox.attributeTypeMap;
    }
}
exports.ClaimsSandbox = ClaimsSandbox;
ClaimsSandbox.discriminator = undefined;
ClaimsSandbox.attributeTypeMap = [
    {
        "name": "id",
        "baseName": "id",
        "type": "string"
    },
    {
        "name": "type",
        "baseName": "type",
        "type": "ClaimsSandbox.TypeEnum"
    },
    {
        "name": "groups",
        "baseName": "groups",
        "type": "Array<ClaimsGroup>"
    }
];
(function (ClaimsSandbox) {
    let TypeEnum;
    (function (TypeEnum) {
        TypeEnum[TypeEnum["Production"] = 'Production'] = "Production";
        TypeEnum[TypeEnum["Developer"] = 'Developer'] = "Developer";
    })(TypeEnum = ClaimsSandbox.TypeEnum || (ClaimsSandbox.TypeEnum = {}));
})(ClaimsSandbox = exports.ClaimsSandbox || (exports.ClaimsSandbox = {}));
//# sourceMappingURL=claimsSandbox.js.map