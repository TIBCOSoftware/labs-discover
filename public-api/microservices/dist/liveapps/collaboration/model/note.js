...
(function (Note) {
    let TypeEnum;
    (function (TypeEnum) {
        TypeEnum[TypeEnum["Issue"] = 'ISSUE'] = "Issue";
        TypeEnum[TypeEnum["Resolution"] = 'RESOLUTION'] = "Resolution";
        TypeEnum[TypeEnum["Question"] = 'QUESTION'] = "Question";
        TypeEnum[TypeEnum["Answer"] = 'ANSWER'] = "Answer";
        TypeEnum[TypeEnum["Informational"] = 'INFORMATIONAL'] = "Informational";
    })(TypeEnum = Note.TypeEnum || (Note.TypeEnum = {}));
    let StatusEnum;
    (function (StatusEnum) {
        StatusEnum[StatusEnum["Unresolved"] = 'UNRESOLVED'] = "Unresolved";
        StatusEnum[StatusEnum["Unanswered"] = 'UNANSWERED'] = "Unanswered";
        StatusEnum[StatusEnum["Resolved"] = 'RESOLVED'] = "Resolved";
        StatusEnum[StatusEnum["Answered"] = 'ANSWERED'] = "Answered";
        StatusEnum[StatusEnum["Accepted"] = 'ACCEPTED'] = "Accepted";
        StatusEnum[StatusEnum["Unaccepted"] = 'UNACCEPTED'] = "Unaccepted";
        StatusEnum[StatusEnum["Unclassified"] = 'UNCLASSIFIED'] = "Unclassified";
    })(StatusEnum = Note.StatusEnum || (Note.StatusEnum = {}));
