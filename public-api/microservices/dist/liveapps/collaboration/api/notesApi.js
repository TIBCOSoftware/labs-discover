...
class NotesApi {
     ...
     */
    createNote(threadNote, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let localVarRequestOptions = {
                ...
                json: true,
                body: models_1.ObjectSerializer.serialize(threadNote, "ThreadNote")
            };
     ...
     */
    createReplyNote(noteId, note, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let localVarRequestOptions = {
                ...
                useQuerystring: this._useQuerystring,
                json: true,
                body: models_1.ObjectSerializer.serialize(note, "Note")
            };
            let authenticationPromise = Promise.resolve();
            authenticationPromise = authenticationPromise.then(() => this.authentications.default.applyToRequest(localVarRequestOptions));
            let interceptorPromise = authenticationPromise;
     ...
     * @param noteId The identifier for a Note.
     */
    deleteNote(noteId, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/notes/{noteId}'
                .replace('{' + 'noteId' + '}', encodeURIComponent(String(noteId)));
            let localVarQueryParameters = {};
     ...
     */
    deleteNotes($filter, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/notes';
            let localVarQueryParameters = {};
            let localVarHeaderParams = Object.assign({}, this._defaultHeaders);
     ...
     * @param noteId The identifier for a Note.
     */
    getNote(noteId, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/notes/{noteId}'
                .replace('{' + 'noteId' + '}', encodeURIComponent(String(noteId)));
            let localVarQueryParameters = {};
     ...
     */
    getNotes($skip, $top, $filter, $orderby, $search, $select, $count, $relatedItemType, $relatedItemId, $relatedItemCollection, $repliesToId, $level, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/notes';
            let localVarQueryParameters = {};
            let localVarHeaderParams = Object.assign({}, this._defaultHeaders);
            ...
            if ($relatedItemCollection !== undefined) {
                localVarQueryParameters['$relatedItemCollection'] = models_1.ObjectSerializer.serialize($relatedItemCollection, "Array<string>");
            }
            if ($repliesToId !== undefined) {
                localVarQueryParameters['$repliesToId'] = models_1.ObjectSerializer.serialize($repliesToId, "string");
            }
            if ($level !== undefined) {
                localVarQueryParameters['$level'] = models_1.ObjectSerializer.serialize($level, "string");
            }
            Object.assign(localVarHeaderParams, options.headers);
            let localVarUseFormData = false;
            let localVarRequestOptions = {
     ...
     */
    updateNote(noteId, note, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/notes/{noteId}'
                .replace('{' + 'noteId' + '}', encodeURIComponent(String(noteId)));
            let localVarQueryParameters = {};
     ...
     */
    updateNotes(notes, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/notes';
            let localVarQueryParameters = {};
            let localVarHeaderParams = Object.assign({}, this._defaultHeaders);
            ...
            let localVarRequestOptions = {
                ...
                useQuerystring: this._useQuerystring,
                json: true,
                body: models_1.ObjectSerializer.serialize(notes, "Array<Note>")
            };
            let authenticationPromise = Promise.resolve();
            authenticationPromise = authenticationPromise.then(() => this.authentications.default.applyToRequest(localVarRequestOptions));
            let interceptorPromise = authenticationPromise;
