...
exports.LastAccessChangesApi = exports.LastAccessChangesApiApiKeys = void 0;
...
// ===============================================
var LastAccessChangesApiApiKeys;
(function (LastAccessChangesApiApiKeys) {
})(LastAccessChangesApiApiKeys = exports.LastAccessChangesApiApiKeys || (exports.LastAccessChangesApiApiKeys = {}));
class LastAccessChangesApi {
    ...
    setApiKey(key, value) {
        this.authentications[LastAccessChangesApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    getLastAccessChange($relatedItemType, $relatedItemId, $relatedItemCollection, options = { headers: {} }) {
                ...
                return new Promise((resolve, reject) => {
                    request_1.default(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            ...
                            body = models_1.ObjectSerializer.deserialize(body, "LastAccessChange");
...
exports.LastAccessChangesApi = LastAccessChangesApi;
//# sourceMappingURL=lastAccessChangesApi.js.map