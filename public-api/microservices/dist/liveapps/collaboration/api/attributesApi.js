...
exports.AttributesApi = exports.AttributesApiApiKeys = void 0;
...
class AttributesApi {
     ...
     */
    createAttribute(noteId, attribute, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let localVarRequestOptions = {
                ...
                json: true,
                body: models_1.ObjectSerializer.serialize(attribute, "NoteAttribute")
            };
     ...
     */
    deleteAttribute(attributeId, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     * @param attributeId The identifier for a NoteAttribute.
     */
    getAttribute(attributeId, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/attributes/{attributeId}'
                .replace('{' + 'attributeId' + '}', encodeURIComponent(String(attributeId)));
            let localVarQueryParameters = {};
                ...
                return new Promise((resolve, reject) => {
                    request_1.default(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            ...
                            body = models_1.ObjectSerializer.deserialize(body, "NoteAttribute");
                            if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                resolve({ response: response, body: body });
                            }
                            else {
     ...
     * @param noteId The identifier for a Note.
     */
    getAttributes(noteId, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/notes/{noteId}/attributes'
                .replace('{' + 'noteId' + '}', encodeURIComponent(String(noteId)));
            let localVarQueryParameters = {};
                ...
                return new Promise((resolve, reject) => {
                    request_1.default(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            ...
                            body = models_1.ObjectSerializer.deserialize(body, "Array<NoteAttribute>");
                            if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                resolve({ response: response, body: body });
                            }
                            else {
     ...
     */
    updateAttribute(attributeId, attribute, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/attributes/{attributeId}'
                .replace('{' + 'attributeId' + '}', encodeURIComponent(String(attributeId)));
            let localVarQueryParameters = {};
     ...
     */
    updateAttributes(noteId, attributes, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/notes/{noteId}/attributes'
                .replace('{' + 'noteId' + '}', encodeURIComponent(String(noteId)));
            let localVarQueryParameters = {};
            ...
            let localVarRequestOptions = {
                ...
                useQuerystring: this._useQuerystring,
                json: true,
                body: models_1.ObjectSerializer.serialize(attributes, "Array<NoteAttribute>")
            };
            let authenticationPromise = Promise.resolve();
            authenticationPromise = authenticationPromise.then(() => this.authentications.default.applyToRequest(localVarRequestOptions));
            let interceptorPromise = authenticationPromise;
