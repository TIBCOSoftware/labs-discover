...
exports.PutCasesRequest = void 0;
/**
* The request type for a PUT /cases request. As the metadata\'s lock property is the only thing that can be updated, everything else is ignored.
*/
class PutCasesRequest {
    static getAttributeTypeMap() {
        return PutCasesRequest.attributeTypeMap;
    }
}
exports.PutCasesRequest = PutCasesRequest;
PutCasesRequest.discriminator = undefined;
PutCasesRequest.attributeTypeMap = [
    {
        "name": "metadata",
        "baseName": "metadata",
        "type": "GetCaseResponseItemMetadata"
    }
];
//# sourceMappingURL=putCasesRequest.js.map