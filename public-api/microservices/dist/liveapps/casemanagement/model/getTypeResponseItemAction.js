...
exports.GetTypeResponseItemAction = void 0;
/**
* The definition of a Case Action process (in the application containing this Case Type).
*/
class GetTypeResponseItemAction {
    static getAttributeTypeMap() {
        return GetTypeResponseItemAction.attributeTypeMap;
    }
}
exports.GetTypeResponseItemAction = GetTypeResponseItemAction;
GetTypeResponseItemAction.discriminator = undefined;
GetTypeResponseItemAction.attributeTypeMap = [
    {
        "name": "id",
        "baseName": "id",
        "type": "string"
...
//# sourceMappingURL=getTypeResponseItemAction.js.map