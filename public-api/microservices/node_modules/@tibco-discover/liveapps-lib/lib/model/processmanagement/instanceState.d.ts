...
export declare type InstanceStateStateEnum = 'STARTING' | 'ACTIVE' | 'COMPLETED' | 'CANCELLED' | 'HALTED' | 'UNKNOWN' | 'DELAYED';
export declare const InstanceStateStateEnum: {
    STARTING: InstanceStateStateEnum;
    ACTIVE: InstanceStateStateEnum;
    COMPLETED: InstanceStateStateEnum;
    CANCELLED: InstanceStateStateEnum;
    HALTED: InstanceStateStateEnum;
    UNKNOWN: InstanceStateStateEnum;
    DELAYED: InstanceStateStateEnum;
};
