...
export declare type ClaimsGroupTypeEnum = 'AllUsers' | 'Administrator' | 'ApplicationDeveloper' | 'UIDeveloper' | 'SubscriptionDefined';
export declare const ClaimsGroupTypeEnum: {
    AllUsers: ClaimsGroupTypeEnum;
    Administrator: ClaimsGroupTypeEnum;
    ApplicationDeveloper: ClaimsGroupTypeEnum;
    UIDeveloper: ClaimsGroupTypeEnum;
    SubscriptionDefined: ClaimsGroupTypeEnum;
};
