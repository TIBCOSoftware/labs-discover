...
export declare type ClaimsSandboxTypeEnum = 'Production' | 'Developer';
export declare const ClaimsSandboxTypeEnum: {
    Production: ClaimsSandboxTypeEnum;
    Developer: ClaimsSandboxTypeEnum;
};
