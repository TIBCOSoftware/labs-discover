...
export declare type SandboxContentTypeEnum = 'Production' | 'Developer';
export declare const SandboxContentTypeEnum: {
    Production: SandboxContentTypeEnum;
    Developer: SandboxContentTypeEnum;
};
