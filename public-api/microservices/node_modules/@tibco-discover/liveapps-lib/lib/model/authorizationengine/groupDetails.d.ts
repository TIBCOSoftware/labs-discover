...
export declare type GroupDetailsTypeEnum = 'AllUsers' | 'Administrator' | 'ApplicationDeveloper' | 'UIDeveloper' | 'SubscriptionDefined';
export declare const GroupDetailsTypeEnum: {
    AllUsers: GroupDetailsTypeEnum;
    Administrator: GroupDetailsTypeEnum;
    ApplicationDeveloper: GroupDetailsTypeEnum;
    UIDeveloper: GroupDetailsTypeEnum;
    SubscriptionDefined: GroupDetailsTypeEnum;
};
