...
var ProcessManagementService = /** @class */ (function () {
    function ProcessManagementService() {
        var _this = this;
        this.basePath = 'https://eu.liveapps.cloud.tibco.com/process/v1';
        /**
         *
         ...
         */
        this.getInstance = function (token, id) {
            var localVarPath = _this.basePath + '/instances/{id}'.replace('{' + 'id' + '}', encodeURIComponent(String(id)));
         ...
         */
        this.listInstances = function (token, sandbox, filter, skip, top) {
            var localVarPath = _this.basePath + '/instances';
            var localVarQueryParameters = {};
         ...
         * @param sandbox The id of the Sandbox from which to return data. (You can obtain Sandbox Ids using the GET /sandboxes method in the Authorization Engine Service.)
         */
        this.getInstanceState = function (token, id, sandbox) {
            var localVarPath = _this.basePath + '/instanceStates/{id}'.replace('{' + 'id' + '}', encodeURIComponent(String(id)));
            var localVarQueryParameters = {};
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
         ...
         */
        this.updateInstanceState = function (token, id, state) {
            var localVarPath = _this.basePath + '/instanceStates/{id}'.replace('{' + 'id' + '}', encodeURIComponent(String(id)));
            var localVarQueryParameters = {};
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
            ...
            return axios_1.default.put(localVarPath, state, {
                headers: { 'Authorization': 'Bearer ' + token },
                params: localVarQueryParameters
            }).then(function (response) {
                return response.data;
         ...
         */
        this.processCreate = function (token, details) {
            var localVarPath = _this.basePath + '/processes';
            var localVarQueryParameters = {};
            ...
            return axios_1.default.post(localVarPath, details, {
                headers: { 'Authorization': 'Bearer ' + token },
                params: localVarQueryParameters
            }).then(function (response) {
                return response.data;
