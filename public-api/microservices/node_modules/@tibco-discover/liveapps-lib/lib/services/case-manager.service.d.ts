...
export declare class CaseManagerService {
     ...
     */
    getCases: (token: string, sandbox?: string | undefined, filter?: string | undefined, select?: string | undefined, skip?: string | undefined, top?: string | undefined, search?: string | undefined, count?: boolean | undefined) => Promise<GetCaseResponseItem[] | CMModelError | number>;
    /**
     ...
     */
    deleteCases: (token: string, sandbox: string, filter: string) => Promise<DeleteCasesResponse | CMModelError>;
    /**
     ...
     */
    updateCase: (token: string, caseReference: string, sandbox: string, select: string, payload: PutCasesRequest) => Promise<GetCaseResponseItem | CMModelError>;
    /**
     *
     ...
     * @param user Test userId for Development sandbox only. Claims must still contain a valid userid but will be overridden when the optional $user parameter is specified
     */
    getCase: (token: string, caseReference: string, sandbox: string, select?: string | undefined) => Promise<GetCaseResponseItem[] | CMModelError>;
    /**
     ...
     */
    getTypes: (token: string, sandbox: string, select?: string | undefined, filter?: string | undefined, skip?: string | undefined, top?: string | undefined, count?: boolean | undefined) => Promise<GetTypeResponseItem[] | CMModelError>;
}
