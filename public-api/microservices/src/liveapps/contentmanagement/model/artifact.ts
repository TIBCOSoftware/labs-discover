...
/**
* The definition of an Artifact. An Artifact can be: * a file or folder within an Application * a file within a Case Folder or Org Folder 
*/
export class Artifact {
    /**
    * The internal id of the Artifact (used by the Web Resource Provisioner Service).
    */
    'id'?: string;
    /**
    * The name (and unique identifier) of the Artifact. For an Application, this name is the full path to the Artifact.
    */
    'name'?: string;
    /**
    ...
    */
    ...
    /**
    * The id of the User who created the Artifact (by first uploading it).
    */
    'author'?: string;
    /**
    ...
    */
    ...
    /**
    * The id of the User who last modified the Artifact.
    */
    'lastModifiedBy'?: string;
    /**
    * The external reference to the actual Artifact.
    */
    'artifactRef'?: string;
    /**
    * The checksum used to determine if the Artifact already exists.
    */
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        {
            "name": "artifactRef",
            "baseName": "artifactRef",
            "type": "string"
        },
        {
            "name": "artifactCheckSum",
            "baseName": "artifactCheckSum",
            "type": "string"
        },
        {
            "name": "ownerApp",
