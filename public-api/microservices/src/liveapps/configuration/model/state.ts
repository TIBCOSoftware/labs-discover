...
import { StateRole } from './stateRole';

/**
* UI state information (such as client-specific customization parameters, and views of the various managed objects within Live Apps - cases, events, and so on).
*/
export class State {
    /**
    * The name of this State.  State names have a uniqueness constraint.  For PRIVATE State, the name must be unique per user, sandboxId, and scope.  For PUBLIC and SHARED State, the name must be unique per type, sandboxId, and scope.  The State name is case-sensitive for uniqueness and filtering (see $filter parameter).
    */
    'name': string;
    'content': StateContent;
    /**
    * An optional State type. Default=PRIVATE.  A PRIVATE State is accessible only by the user who created it, who implicitly has the role of OWNER.  A SHARED State is accessible based on roles.  A PUBLIC State can be read by all users (all users implicitly have a role of RECIPIENT), while OWNER and AUTHOR roles still apply for changing the State.
    */
    'type'?: State.TypeEnum;
    /**
    * An optional description of this State.
    */
    'description'?: string;
    /**
    * An optional unique sandbox identifier, default=[the PRODUCTION sandbox ID of the user creating this State].
    */
    'sandboxId'?: string;
    /**
    * An optional value used to qualify a context for this State. Defaults to a zero-length string.
    */
    'scope'?: string;
    /**
    * An optional set of named attributes that may be relevant to this State.
    */
    'attributes'?: Array<StateAttribute>;
    /**
    * An optional set of StateRole assignments.
    */
    'roles'?: Array<StateRole>;
    /**
    * An optional set of links to other States.
    */
    'links'?: Array<StateLink>;
    /**
    * Set by the service.  The unique identifier for this State, assigned by the service when created.
    */
    'id'?: string;
    /**
    ...
    */
    'createdById'?: string;
    /**
    * Set by the service.  The display name of the User who created this State.  This value is set by the service when a State is created and is used for display purposes only.  If the User has been deleted then this value is set to \'Unknown User\'.
    */
    'createdByName'?: string;
    /**
    * Set by the service.  The date-time (UTC) when this State was created.  This property is maintained by the service.
    */
    'createdDate'?: Date;
    /**
    * Set by the service.  The unique identifier for the User who last modified this State.  This value is set by the service when a State is modified.
    */
    'modifiedById'?: string;
    /**
    * Set by the service.  The display name of the User who last modified this State.  This value is set by the service when a State is modified and is used for display purposes only.  If the User has been deleted then this value is set to \'Unknown User\'.
    */
    'modifiedByName'?: string;
    /**
    * Set by the service.  The date-time (UTC) when this State was last modified.  This property is maintained by the service.
    */
    'modifiedDate'?: Date;
    /**
    * Set by the service.  This is set true for SHARED or PUBLIC State if the user who created the State is deleted.
    */
    'isOrphaned'?: boolean;
    /**
    * Set by the service.  This is set true for SHARED or PUBLIC State if no OWNER exists as a result of either of these conditions:  - The user who created the State is deleted, and no other OWNER Role exists. - A group, which is the only OWNER Role, is deleted, and the State isOrphaned flag is set.  <br>In either case, the inherent System ADMINISTRATOR group is assigned an OWNER Role to ensure that OWNER Role access to the State exists. <br>This flag is cleared if an OWNER Role is subsequently assigned. 
    */
    'isAbandoned'?: boolean;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "roles",
            "baseName": "roles",
            "type": "Array<StateRole>"
        },
        {
            "name": "links",
            "baseName": "links",
            "type": "Array<StateLink>"
        },
        {
            "name": "id",
            "baseName": "id",
