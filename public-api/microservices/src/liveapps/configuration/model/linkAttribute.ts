...
/**
* A name/value pair relevant to a StateLink.
*/
export class LinkAttribute {
    ...
    */
    'value': string;
    /**
    * Set by the service.  The unique identifier for this LinkAttribute, assigned by the service when created.
    */
    'id'?: string;
    /**
    * The linkedStateId value of the StateLink to which this LinkAttribute is assigned.
    */
    'linkedId'?: string;
    /**
    * The stateId value of the StateLink to which this LinkAttribute is assigned.
    */
    'stateId'?: string;
    ...
    static getAttributeTypeMap() {
        return LinkAttribute.attributeTypeMap;
    }
}
