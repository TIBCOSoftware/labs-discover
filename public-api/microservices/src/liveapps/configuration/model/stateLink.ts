...
export class StateLink {
    /**
    * The identifier for the State being linked to.
    */
    'linkedStateId': string;
    /**
    * An optional set of named attributes that may be relevant to this Link.
    */
    'attributes'?: Array<LinkAttribute>;
    /**
    * Set by the service.  The unique identifier for this StateLink, assigned by the service when created.
    */
    'id'?: string;
    /**
    * The unique identifier for the State to which this StateLink is assigned.
    */
    'stateId'?: string;
