...
import { NoteAttribute } from '../model/noteAttribute';
...
export class AttributesApi {
    ...
    /**
     * Creates a new NoteAttribute for a Note.
     * @summary Creates a NoteAttribute.
     * @param noteId The identifier for a Note.
     * @param attribute The NoteAttribute to be added.
     */
    public async createAttribute (noteId: string, attribute: NoteAttribute, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: string;  }> {
        const localVarPath = this.basePath + '/notes/{noteId}/attributes'
        ...
        if (noteId === null || noteId === undefined) {
            throw new Error('Required parameter noteId was null or undefined when calling createAttribute.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(attribute, "NoteAttribute")
        };
    ...
    /**
     * Deletes the NoteAttribute matching the given ID.  The User must have delete access to the NoteAttribute (the User has at least an OWNER Role for the Thread associated with this NoteAttribute), or an error is returned.
     * @summary Deletes a NoteAttribute.
     * @param attributeId The identifier for a NoteAttribute.
     */
    public async deleteAttribute (attributeId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/attributes/{attributeId}'
    ...
    /**
     * Returns the NoteAttribute matching the given ID.
     * @summary Gets a NoteAttribute.
     * @param attributeId The identifier for a NoteAttribute.
     */
    public async getAttribute (attributeId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: NoteAttribute;  }> {
        const localVarPath = this.basePath + '/attributes/{attributeId}'
            .replace('{' + 'attributeId' + '}', encodeURIComponent(String(attributeId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: NoteAttribute;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "NoteAttribute");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
    ...
    /**
     * Returns NoteAttributes from the Note matching the id.
     * @summary Gets NoteAttributes.
     * @param noteId The identifier for a Note.
     */
    public async getAttributes (noteId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<NoteAttribute>;  }> {
        const localVarPath = this.basePath + '/notes/{noteId}/attributes'
            .replace('{' + 'noteId' + '}', encodeURIComponent(String(noteId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'noteId' is not null or undefined
        if (noteId === null || noteId === undefined) {
            throw new Error('Required parameter noteId was null or undefined when calling getAttributes.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: Array<NoteAttribute>;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "Array<NoteAttribute>");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
    ...
    /**
     * Updates the NoteAttribute matching the given ID. <br>The id property of the payload must match the attributeId specified on the URL. 
     * @summary Updates a NoteAttribute.
     * @param attributeId The identifier for a NoteAttribute.
     * @param attribute The NoteAttribute to be updated.
     */
    public async updateAttribute (attributeId: string, attribute: NoteAttribute, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: NoteAttribute;  }> {
        const localVarPath = this.basePath + '/attributes/{attributeId}'
            .replace('{' + 'attributeId' + '}', encodeURIComponent(String(attributeId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
    ...
    /**
     * Updates the NoteAttributes for a Note.  Either all NoteAttributes are updated, or none of them are updated if an error occurs.
     * @summary Updates NoteAttributes.
     * @param noteId The identifier for a Note.
     * @param attributes The Attributes to be updated (containing at least one).
     */
    public async updateAttributes (noteId: string, attributes: Array<NoteAttribute>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<NoteAttribute>;  }> {
        const localVarPath = this.basePath + '/notes/{noteId}/attributes'
            .replace('{' + 'noteId' + '}', encodeURIComponent(String(noteId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'noteId' is not null or undefined
        if (noteId === null || noteId === undefined) {
            throw new Error('Required parameter noteId was null or undefined when calling updateAttributes.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(attributes, "Array<NoteAttribute>")
        };
