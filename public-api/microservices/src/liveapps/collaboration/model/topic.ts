...
/**
* A new Topic is created by the service when a new top-level Note is created that is the first Note associated with a given Related Item.  This is maintained by the service and contains statistical information for all Notes for this Topic.  All Topic properties are read-only.
*/
export class Topic {
    /**
    ...
    */
    ...
    /**
    * A list of Collection name values used to associate this Topic with those Collection names.  This property can be initially set on a new Topic using the ThreadNote.relatedItemCollection property and subsequently updated using the PUT /topics request.
    */
    'relatedItemCollection'?: Array<string>;
    /**
    * The date-time (UTC) when this Topic was created.  This property is maintained by the service.
    */
    'createdDate'?: Date;
    /**
    * The date-time (UTC) when any Note for this Topic was last added, modified, or deleted.
    */
    'actionDate'?: Date;
    /**
    * The unique identifier for the Note in this Topic that was last added or modified.  The value is null when the actionType is DELETE.
    */
    'actionId'?: string;
    /**
    * The type of the last associated Note action.  POST for a new top-level Note, REPLY for a new Note that is a reply to a Note, UPDATE for any change to a Note, DELETE for a deleted Note.
    */
    'actionType'?: Topic.ActionTypeEnum;
    /**
    * The total number of Notes in this Topic.
    */
    'totalCount'?: number;
    /**
    * The total number of top-level Notes (Threads) in this Topic.
    */
    'threadCount'?: number;
    /**
    * The total number of Notes in this Topic that have an ISSUE type.
    */
    'issueNoteCount'?: number;
    /**
    * The total number of Notes in this Topic that have a RESOLUTION type.
    */
    'resolutionNoteCount'?: number;
    /**
    * The total number of Notes in this Topic that have a QUESTION type.
    */
    'questionNoteCount'?: number;
    /**
    * The total number of Notes in this Topic that have an ANSWER type.
    */
    'answerNoteCount'?: number;
    /**
    * The total number of Notes in this Topic that have an INFORMATIONAL type.
    */
    'informationalNoteCount'?: number;
    /**
    * The total number of Notes in this Topic that have an UNRESOLVED status.
    */
    'unresolvedStatusCount'?: number;
    /**
    * The total number of Notes in this Topic that have an UNANSWERED status.
    */
    'unansweredStatusCount'?: number;
    /**
    * The total number of Notes in this Topic that have a RESOLVED status.
    */
    'resolvedStatusCount'?: number;
    /**
    * The total number of Notes in this Topic that have an ANSWERED status.
    */
    'answeredStatusCount'?: number;
    /**
    * The total number of Notes in this Topic that have an ACCEPTED status.
    */
    'acceptedStatusCount'?: number;
    /**
    * The total number of Notes in this Topic that have an UNACCEPTED status.
    */
    'unacceptedStatusCount'?: number;
    /**
    * The total number of Notes in this Topic that have an UNCLASSIFIED status.
    */
