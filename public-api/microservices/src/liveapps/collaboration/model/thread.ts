...
import { ThreadRole } from './threadRole';
...
export class Thread {
    ...
    */
    'id'?: string;
    /**
    * The type of the Related Item.  Set by the service when created.
    */
    'relatedItemType'?: string;
    /**
    * The ID for the Related Item.  Set by the service when created.
    */
    'relatedItemId'?: string;
    /**
    * A list of Collection name values used to associate the Topic this Thread belongs to with those Collection names.  This property is maintained by the service.
    */
    'relatedItemCollection'?: Array<string>;
    /**
    * The unique identifier for the Topic this Thread belongs to.  This is assigned by the service when created.
    */
    'topicId'?: string;
    /**
    * The unique identifier for the top-level Note that began this Thread.  This is assigned by the service when created.
    */
    'topLevelNoteId'?: string;
    /**
    * The status of the Thread.  This value is set by the service to indicate the current status of this Thread.  These are set as follows.  OPEN indicates a top-level Note that is an ISSUE or QUESTION that has not yet received a RESOLUTION or ANSWER reply.  PENDING indicates a RESOLUTION or ANSWER reply has been posted but not yet accepted.  COMPLETE indicates a RESOLUTION or ANSWER has been accepted.  INFO indicates a top-level Note that is INFORMATIONAL.
    */
    'status'?: Thread.StatusEnum;
    /**
    * This is set to true if the Thread has been locked.  A locked Thread prevents any further reply Notes being added to the Thread.  This does not prevent updates on Notes in the Thread.  Only the Thread creator, an OWNER, or MODERATOR can change this value.
    */
    'isLocked'?: boolean;
    /**
    * An optional value that together with lifecycledWithId identify the Topic that this Thread is life-cycled with. - If set, this must be a non-zero length value (limited to 100 characters in length) and must be specified together with lifecycledWithId. - Any UTF-8 characters can be used. - The property is treated as case sensitive, and white space is significant (not ignored). - All lifecycledWithType values that start with \'LIVEAPPS_\', \'DT_\', or \'RT_\' are reserved for internal use by Live Apps. 
    */
    'lifecycledWithType'?: string;
    /**
    * An optional value that together with lifecycledWithType identify the Topic that this Thread is life-cycled with. - If set, this must be a non-zero length value (limited to 100 characters in length) and must be specified together with lifecycledWithType. - Any UTF-8 characters can be used. - The property is treated as case sensitive, and white space is significant (not ignored). 
    */
    ...
    */
    'createdById'?: string;
    /**
    * The username of the User who created this Thread.  This value is set by the service when a Thread is created and is used for display purposes only.  If the User has been deleted then this value is set to \'Unknown User\'.
    */
    'createdByName'?: string;
    /**
    * The date-time (UTC) when this Thread was created.  This property is maintained by the service.
    */
    'createdDate'?: Date;
    /**
    * The unique identifier for the User who last modified this Thread.  A Thread is modified when isLocked, lifecycledWithType, lifecycledWithId, or roles are changed.  This value is set by the service when a Thread is modified.
    */
    'modifiedById'?: string;
    /**
    ...
    */
    ...
    /**
    * The date-time (UTC) when this Thread was last modified.  A Thread is modified when isLocked, lifecycledWithType, lifecycledWithId, or roles are changed.  This property is maintained by the service.
    */
    'modifiedDate'?: Date;
    /**
    * The date-time (UTC) when any Note in this Thread was last added, modified, or deleted.
    */
    'actionDate'?: Date;
    /**
    * The unique identifier for the Note in this Thread that was last added or modified.  The value is null when the actionType is DELETE.
    */
    'actionId'?: string;
    /**
    * The type of the last associated Note action.  POST for a new top-level Note, REPLY for a new Note that is a reply to a Note, UPDATE for any change to a Note, or DELETE for a deleted Note.
    */
    'actionType'?: Thread.ActionTypeEnum;
    /**
    * The Roles associated with this Thread.
    */
    'roles'?: Array<ThreadRole>;
    /**
    * The total number of Notes in this Thread.
    */
    'totalCount'?: number;
    /**
    * The total number of Notes in this Thread that have an ISSUE type.
    */
    'issueNoteCount'?: number;
    /**
    * The total number of Notes in this Thread that have a RESOLUTION type.
    */
    'resolutionNoteCount'?: number;
    /**
    * The total number of Notes in this Thread that have a QUESTION type.
    */
    'questionNoteCount'?: number;
    /**
    * The total number of Notes in this Thread that have an ANSWER type.
    */
    'answerNoteCount'?: number;
    /**
    * The total number of Notes in this Thread that have an INFORMATIONAL type.
    */
    'informationalNoteCount'?: number;
    /**
    * The total number of Notes in this Thread that have an UNRESOLVED status.
    */
    'unresolvedStatusCount'?: number;
    /**
    * The total number of Notes in this Thread that have an UNANSWERED status.
    */
    'unansweredStatusCount'?: number;
    /**
    * The total number of Notes in this Thread that have a RESOLVED status.
    */
    'resolvedStatusCount'?: number;
    /**
    * The total number of Notes in this Thread that have an ANSWERED status.
    */
    'answeredStatusCount'?: number;
    /**
    * The total number of Notes in this Thread that have an ACCEPTED status.
    */
    'acceptedStatusCount'?: number;
    /**
    * The total number of Notes in this Thread that have an UNACCEPTED status.
    */
    'unacceptedStatusCount'?: number;
    /**
    * The total number of Notes in this Thread that have an UNCLASSIFIED status.
    */
    'unclassifiedStatusCount'?: number;
    /**
    * This is true if the User who created the Thread is deleted.
    */
    'isOrphaned'?: boolean;
    /**
    * This is true if no OWNER exists as a result of either of these conditions: - the User who created the Thread is deleted and no other OWNER Role exists. - a Group is deleted, which is the only OWNER Role and the Thread isOrphaned flag is set. 
    */
    'isAbandoned'?: boolean;
