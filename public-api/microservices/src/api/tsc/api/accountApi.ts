...
let defaultBasePath = 'http://eu.account.cloud.tibco.com';
...
export class AccountApi {
     ...
     */
    public async getAccountInfo (options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<User>;  }> {
        const localVarPath = this.basePath + '/tsc-ws/v1/account/user';
