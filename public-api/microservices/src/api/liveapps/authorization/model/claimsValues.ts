...
export class ClaimsValues {
    ...
    */
    'email'?: string;
    /**
    * The global ID of the subscription the User belongs to.   Typically has the same value as subscriptionId
    */
    'globalSubcriptionId'?: string;
    /**
    * The region in which the subscription resides.
    */
    'region'?: string;
    /**
    * The globally unique ID for the subscription the user belongs to.   Typically has the same value as globalSubsriptionId
    */
    'guid'?: string;
    /**
    ...
    */
    'sandboxes'?: Array<ClaimsSandbox>;
    /**
    * A list of user ID\'s for users the current user is an alternate for based on any UserRule\'s that were active when the claims were created, i.e. when the user logged in.
    */
    'alternateUsers'?: Array<string>;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        {
            "name": "globalSubcriptionId",
            "baseName": "globalSubcriptionId",
            "type": "string"
        },
        {
            "name": "region",
        ...
        },
        {
            "name": "sandboxes",
            "baseName": "sandboxes",
            "type": "Array<ClaimsSandbox>"
        },
        {
            "name": "alternateUsers",
            "baseName": "alternateUsers",
            "type": "Array<string>"
        }    ];

    static getAttributeTypeMap() {
        return ClaimsValues.attributeTypeMap;
    }
}
