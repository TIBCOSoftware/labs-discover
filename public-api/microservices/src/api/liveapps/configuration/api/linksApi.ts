...
import { StateLink } from '../model/stateLink';
...
export class LinksApi {
    ...
    /**
     * Creates a new StateLink.  A State can be linked to any other States.
     * @summary Creates a StateLink.
     * @param id The identifier for a State.
     * @param link The StateLink to be added.
     */
    public async createLink (id: string, link: StateLink, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: string;  }> {
        const localVarPath = this.basePath + '/states/{id}/links'
        ...
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling createLink.');
        }

        // verify required parameter 'link' is not null or undefined
        if (link === null || link === undefined) {
            throw new Error('Required parameter link was null or undefined when calling createLink.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(link, "StateLink")
        };
    ...
    /**
     * Deletes the StateLink matching the given id.
     * @summary Deletes a StateLink.
     * @param id The identifier for a StateLink.
     */
    public async deleteLink (id: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/stateLinks/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json', 'text/plain'];
    ...
    /**
     * Returns the StateLink matching the given id.
     * @summary Gets a StateLink.
     * @param id The identifier for a StateLink.
     */
    public async getLink (id: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: StateLink;  }> {
        const localVarPath = this.basePath + '/stateLinks/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: StateLink;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "StateLink");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
    ...
    /**
     * Returns StateLinks from the State matching the id.
     * @summary Gets StateLinks.
     * @param id The identifier for a State.
     */
    public async getLinks (id: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<StateLink>;  }> {
        const localVarPath = this.basePath + '/states/{id}/links'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling getLinks.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: Array<StateLink>;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "Array<StateLink>");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
    ...
    /**
     * Updates the StateLink matching the given id.
     * @summary Updates a StateLink.
     * @param id The identifier for a StateLink.
     * @param link The StateLink to be updated.
     */
    public async updateLink (id: string, link: StateLink, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: StateLink;  }> {
        const localVarPath = this.basePath + '/stateLinks/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'link' is not null or undefined
        if (link === null || link === undefined) {
            throw new Error('Required parameter link was null or undefined when calling updateLink.');
        }
    ...
    /**
     * Updates the StateLinks.  Either all StateLinks are updated, or none are updated if an error occurs.
     * @summary Updates StateLinks.
     * @param id The identifier for a State.
     * @param links The links to be updated (containing at least one).
     */
    public async updateLinks (id: string, links: Array<StateLink>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<StateLink>;  }> {
        const localVarPath = this.basePath + '/states/{id}/links'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling updateLinks.');
        }

        // verify required parameter 'links' is not null or undefined
        if (links === null || links === undefined) {
            throw new Error('Required parameter links was null or undefined when calling updateLinks.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(links, "Array<StateLink>")
        };
