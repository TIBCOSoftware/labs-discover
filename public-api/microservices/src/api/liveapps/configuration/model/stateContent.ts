...
/**
* A generic JSON object containing UI state information.  The content of the JSON is opaque to this service, which knows nothing about the schema.
*/
export class StateContent {
    ...
    */
    ...
    static getAttributeTypeMap() {
        return StateContent.attributeTypeMap;
    }
}
