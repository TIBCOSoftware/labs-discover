...
/**
* Assigns an access role to an Organization Model Entity, which provides shared access to a non-private State (a State of SHARED or PUBLIC).  Each StateRole matches a role (OWNER, AUTHOR, or RECIPIENT) to an Organization Model Entity (group).  The current User\'s memberships in the Organization Model then determines what role the user has to access a given State.  The user who creates a State implicitly has a role of OWNER.  Roles do not apply when the State type is set to PRIVATE, since in that case, the State is accessible only by the user who created it.  If a State or an Organization Model Entity is deleted, any associated StateRole is also deleted automatically. 
*/
export class StateRole {
    /**
    * The unique identifier for an Organization Model Entity.
    */
    'entityId': string;
    /**
    * Role controlling access to States.  One of [\"OWNER\", \"AUTHOR\", \"RECIPIENT\"]. - An OWNER can create/delete/read/update State, and add or remove OWNER, AUTHOR, and RECIPIENT roles. - An AUTHOR can read/update State, and add or remove AUTHOR and RECIPIENT roles. - A RECIPIENT can only read State. 
    */
    'role': StateRole.RoleEnum;
    /**
    * Set by the service.  The unique identifier for this StateRole, assigned by the service when created.
    */
    'id'?: string;
    /**
    * The unique identifier for the State to which this StateRole is assigned.
    */
    'stateId'?: string;
    /**
    * Set by the service.  The display name of the Organization Model Entity specified by entityId.  This value is set by the service when a StateRole is created and is used for display purposes only.
    */
    'entityName'?: string;
    /**
    * Set by the service.  The type of Organization Model Entity specified by entityId.  This value is set by the service when a StateRole is created and cannot be modified.
    */
    'entityType'?: StateRole.EntityTypeEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "entityType",
            "baseName": "entityType",
            "type": "StateRole.EntityTypeEnum"
        }    ];

    static getAttributeTypeMap() {
        return StateRole.attributeTypeMap;
    }
}

export namespace StateRole {
