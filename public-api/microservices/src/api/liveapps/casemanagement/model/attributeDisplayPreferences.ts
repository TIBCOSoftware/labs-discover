...
*/
export class AttributeDisplayPreferences {
    /**
    * true if clients should present the attribute\'s value in a multi-line control as opposed to a single line control 
    */
    'multiLine'?: boolean;
    /**
    * a string clients should present as a prefix to attribute values. For example, an attribute representing currency may have a prefix \'$\' representing dollars. 
    */
    'prefix'?: string;
    /**
    * a string clients should present as a suffix to attribute values. For example, an attribute representing a person\'s age may have a suffix \'year(s)\'. 
    */
    'suffix'?: string;
    ...
    static getAttributeTypeMap() {
        return AttributeDisplayPreferences.attributeTypeMap;
    }
}
