...
/**
* The Definition of a particular version of an Application.
*/
export class ApplicationVersion {
    /**
    * The internal id of the ApplicationVersion (used by the Web Resource Provisioner Service).
    */
    'id'?: string;
    /**
    * The id of the Application that owns the ApplicationVersion.
    */
    'ownerApp'?: string;
    /**
    * The version number (and unique identifier) of the ApplicationVersion.
    */
    'version'?: string;
    /**
    * The name of the ApplicationVersion.
    */
    'name': string;
    /**
    * The date on which the ApplicationVersion was created.
    */
    'creationDate'?: string;
    /**
    * The date on which the ApplicationVersion was last modified.
    */
    'lastModifiedDate'?: string;
    /**
    * The id of the User who last modified the application.
    */
    'lastModifiedBy'?: string;
    /**
    * The permissions for the ApplicationVersion (not currently used).
    */
    'permissions'?: number;
    /**
    * The label to display for this ApplicationVersion.
    */
    'label'?: string;
