...
/**
* The definition of an Application, System Application, Case Folder or Org Folder. (This object is used for the definition of all four resources.)
*/
export class Application {
    /**
    * The internal id of the object (used by the Web Resource Provisioner Service).
    */
    'id'?: string;
    /**
    * The name (and unique identifier) of the object.
    */
    'name': string;
    /**
    ...
    */
    'owner'?: string;
    /**
    * The id of the subscription to which the object belongs.
    */
    'ownerSub'?: string;
    /**
    * The id of the Sandbox to which the object belongs.
    */
    'ownerSandbox'?: string;
    /**
    ...
    */
    ...
    /**
    * The currently published Version of the object.
    */
    ...
    */
    ...
    /**
    * The internal id of the published version of the object (used by the Web Resource Provisioner Service).
    */
    'publishedVersionId'?: string;
    /**
    * The internal id of the latest version of the object (used by the Web Resource Provisioner Service).
    */
    'latestVersionId'?: string;
    /**
    * The publish checksum, used to determine if the object has changed.
    */
    'checksum'?: string;
    /**
    * The external reference to the object.
    */
    'extRef'?: string;
    'tags'?: Array<Tag>;
    /**
    * The contents of the Application\'s or System Application\'s {appName}.app.desc.json descriptor file (if it has one). This property is not used for a Case Folder.
    */
    'descriptor'?: string;
