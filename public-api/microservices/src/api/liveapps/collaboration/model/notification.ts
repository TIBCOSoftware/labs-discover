...
import { NotifyCollection } from './notifyCollection';

/**
* Assigns notification for activity on a Collection, Topic, or Thread to an Organization Model Entity.  When specific changes are made to Notes associated with a Collection, Topic, or Thread, the Organization Model Entity (Group or User) defined here receives the type of notification indicated.  The user making the change on the Note does not receive a notification.  When creating a new Notification, the scope of the Notification (Collection, Topic, Thread) is specified as follows:  - To create a Notification for a Collection, set the appropriate values for NotifyCollection and set topicId and threadId to null. - To create a Notification for a Topic, set topicId to the ID of the Topic and set threadId and notifyCollection to null. - To create a Notification for a Thread, set threadId to the ID of the Thread and set topicID and notifyCollection to null. - In the case of specifying a Notification on a ThreadNote when creating a new top-level Note, this is inherently creating a Thread Notification and notifyCollection, topicId, and threadId must be omitted or null.  Only one of these conditions can exist.  An exception is thrown if none of these conditions exist or if more than one of these conditions exist.  If Notifications include a User more than once for a given notice event, only a single Notification is sent.  If a Related Item, Thread, or Organization Model Entity is deleted, any associated Notification is also deleted automatically. 
*/
export class Notification {
    /**
    * The unique identifier for an Organization Model Entity (Group or User).  If both entityId and entityType are omitted (or set to null), these values are set for the current User.
    */
    'entityId'?: string;
    /**
    * The type of Organization Model Entity specified by entityId.  If both entityId and entityType are omitted (or set to null), these values are set for the current User.
    */
    'entityType'?: Notification.EntityTypeEnum;
    /**
    * An optional type for the Notification (default = EMAIL).  SMS is not supported at this time.
    */
    'type'?: Notification.TypeEnum;
    /**
    * Set by the service.  The unique identifier for this Notification, which is assigned by the service when the Notification is created.
    */
    'id'?: string;
    'notifyCollection'?: NotifyCollection;
    /**
    * The unique identifier for the Topic to which this Notification is assigned.  Null if notifyCollection or threadId is specified, or when set on a ThreadNote.
    */
    'topicId'?: string;
    /**
    * The unique identifier for the Thread to which this Notification is assigned.  Null if notifyCollection or topicId is specified, or when set on a ThreadNote.
    */
    'threadId'?: string;
    /**
    * Set by the service.  The display name of the Organization Model Entity specified by entityId.  This value is set by the service when a Notification is created and is used for display purposes only.
    */
    'entityName'?: string;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "entityType",
            "baseName": "entityType",
            "type": "Notification.EntityTypeEnum"
        },
        {
            "name": "type",
            "baseName": "type",
        ...
        {
            "name": "notifyOnUpdate",
            "baseName": "notifyOnUpdate",
            "type": "boolean"
        },
        {
            "name": "notifyOnAllReplies",
            "baseName": "notifyOnAllReplies",
            "type": "boolean"
        }    ];
