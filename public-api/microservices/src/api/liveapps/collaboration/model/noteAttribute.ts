...
/**
* A name/value pair relevant to a Note.
*/
export class NoteAttribute {
    ...
    */
    'name': string;
    /**
    * The Note Attribute value.
    */
    'value': string;
    /**
    * Set by the service.  The unique identifier for this NoteAttribute assigned by the service when created.
    */
    'id'?: string;
    /**
    * Set by the service.  The unique identifier for the Note that this NoteAttribute is assigned to.
    */
    'noteId'?: string;
    ...
    static getAttributeTypeMap() {
        return NoteAttribute.attributeTypeMap;
    }
}
